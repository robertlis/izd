...
# Необходимый дисклеймер к разделу /izd
Для писателей: читая отзывы анонимов на свой рассказ, стоит помнить, среднестатистический читатель не похож на среднестатистического комментатора этого раздела. Здесь обитают воннаби-писатели — а воннаби-писатель, а тем более двачер, может иметь мотив слишком драматизировать недостатки и не замечать достоинств другого воннаби-писателя. "У поэтов есть такой обычай: в круг собравшись, оплёвывать друг друга".

Для критиков: если твоя цель — помочь автору, то сосредоточься в первую очередь на сильных сторонах критикуемого. Найди что-то ценное и похвали за это. Это одновременно и закрепляет тот полезный навык, который у автора уже есть, и мотивирует сделать что-то ещё. Разумеется, это не значит, что негативная критика не нужна — но положительная должна быть в приоритете.
